      ...
      <div className="bg-white py-16 text-center px-4 relative overflow-hidden z-10">
         ...
         <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-xl font-medium">
              We are easy to find. Reach out to us for any inquiries or assistance.
            </p>
         </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 leading-relaxed text-lg font-medium">
              Have a question about our rooms, conference facilities, or dining options? We are always ready to help. Contact us using the details below or send us a message.
            </p>

            <div className="space-y-6 mb-10">
              <div className="flex items-start gap-5 p-4 rounded-2xl hover:bg-gold/5 transition-colors border border-transparent hover:border-gold/20">
                <div className="p-3 bg-black rounded-xl text-gold shadow-md shrink-0">
                  <MapPin size={24} />
                </div>
                <div>
                  <h3 className="font-bold text-black mb-1 text-lg">Address</h3>
                  <p className="text-gray-600 font-medium">
                    Just minutes away from Kayonza Bus Park<br />
                    Kayonza, Eastern Province, Rwanda
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5 p-4 rounded-2xl hover:bg-gold/5 transition-colors border border-transparent hover:border-gold/20">
                ...
                <div>
                  <h3 className="font-bold text-black mb-1 text-lg">Phone</h3>
                  <p className="text-gray-600 font-medium">+250 123 456 789</p>
                  <p className="text-gray-600 font-medium">+250 987 654 321</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5 p-4 rounded-2xl hover:bg-gold/5 transition-colors border border-transparent hover:border-gold/20">
                ...
                <div>
                  <h3 className="font-bold text-black mb-1 text-lg">Email</h3>
                  <p className="text-gray-600 font-medium">info@midlandhotel.rw</p>
                  <p className="text-gray-600 font-medium">bookings@midlandhotel.rw</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5 p-4 rounded-2xl hover:bg-gold/5 transition-colors border border-transparent hover:border-gold/20">
                ...
                <div>
                  <h3 className="font-bold text-black mb-1 text-lg">Reception</h3>
                  <p className="text-gray-600 font-medium">Open 24/7</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border-2 border-gray-100 relative overflow-hidden">
              ...
              {formStatus === "success" ? (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-6 font-medium">Thank you for contacting us. Our team will get back to you as soon as possible.</p>
                  <button 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button 
                    ...
                    className="w-full bg-black hover:bg-gray-900 text-white py-4 rounded-xl font-bold text-lg transition-all shadow-[0_10px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_15px_30px_rgba(251,191,36,0.3)] disabled:opacity-70 flex justify-center items-center gap-3 group relative overflow-hidden"
                  >
